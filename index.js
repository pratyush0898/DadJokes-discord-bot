...
const USER_AGENT = 'DadJokes Discord Bot (https://github.com/yourusername/dadjokes-bot)';
        ...
        switch (commandName) {
            ...
            case 'jokeid':
                ...
                if (specificJoke) {
                    ...
                    await interaction.editReply(`❌ Couldn't find a joke with ID: \`${jokeId}\`. Please check the ID and try again.`);
                }
                break;
            ...
            case 'search':
                ...
                if (searchResults && searchResults.results.length > 0) {
                    ...
                    const embed = new EmbedBuilder()
                        ...
                        .setDescription(`Found ${searchResults.total_jokes} joke(s). Showing ${jokes.length}:`)
                        .setFooter({ 
                    ...
                    await interaction.editReply(`❌ No jokes found for "${searchTerm}". Try a different search term!`);
                }
                break;
            ...
            case 'help':
                const helpEmbed = new EmbedBuilder()
                    ...
                    .setDescription('A Discord bot that brings you the best dad jokes from icanhazdadjoke.com!')
                    .addFields(
                        { name: '📝 Commands', value: '\u200B', inline: false },
                        { name: '/joke', value: 'Get a random dad joke', inline: true },
                        { name: '/jokeid <id>', value: 'Get a specific joke by ID', inline: true },
                        { name: '/search <term> [limit]', value: 'Search for jokes (1-10 results)', inline: true },
                        { name: '/help', value: 'Show this help message', inline: true },
                        { name: '🔗 Links', value: '[icanhazdadjoke.com](https://icanhazdadjoke.com)', inline: false }
                    )
...
client.on('messageCreate', message => {
    ...
    if (content === '!joke' || content === 'dad joke' || content.includes('tell me a joke')) {
